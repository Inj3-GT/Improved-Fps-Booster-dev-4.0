...
Ipr_Fps_Booster.Lang["FR"] = {
    ...
    StartupLaunched = "Le démarrage est activé automatiquement dans 5 minutes pour éviter un crash, veuillez patienter !",
...
Ipr_Fps_Booster.Lang["EN"] = {
    ...
    StartupLaunched = "Startup launch is enabled automatically in 5 minutes for prevent crash, please wait !",
