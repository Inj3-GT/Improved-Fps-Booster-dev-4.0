...
Ipr.Function.DrawMultipleTextAligned = function(tbl)
    ...
    for t = 1, #tbl do
        ...
        for i = 1, #Ipr_TextTbl do
            ...
            draw.SimpleTextOutlined(Ipr_NameText, Ipr.Settings.Font, Ipr_Pos.PWide + Ipr_NewWide, Ipr_Pos.PHeight, Ipr_TextTbl[i].FColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_LEFT, 0.5, color_black)
        end
